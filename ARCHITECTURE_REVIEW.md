...
- Ship gates: CI workflow now encodes disposable-Postgres migration deploy, production audit, Prisma validation, full/focused tests, red-team, typecheck, build and all browser proofs; `verify:prod` remains the explicit post-deploy release check.
