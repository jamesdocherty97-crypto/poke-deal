...
- **Decision:** Pin Next.js to the current security-backport release `15.5.21` while retaining React/React DOM `18.3.1`, and scope-override Next's bundled PostCSS to an audit-clean `8.5.x` patch (currently `8.5.18`). Convert dynamic route-handler params to Next 15's asynchronous contract. Do not combine this security move with a React 19 migration.
