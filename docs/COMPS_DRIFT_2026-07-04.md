...
Corpus: 28 pinned live-regression cards
Summary: 7 OK · 21 drift · 0 error
...
| DRIFT | `dark-charizard-team-rocket-4-82-raw.json` | Dark Charizard · Team Rocket · 4/82 · RAW | £387.06 · pokemon-tcg-market · low · manual | £264.16 · poketrace · medium · auto | confidence low -> medium; manual true -> false; headline source pokemon-tcg-market -> poketrace; headline moved £387.06 -> £264.16 (32%) |
...
| DRIFT | `gengar-lost-origin-tg06-raw.json` | Gengar · Lost Origin · TG06 · RAW | £135.63 · pokemon-price-tracker · low · manual | £44.21 · poketrace · high · auto | confidence low -> high; manual true -> false; headline source pokemon-price-tracker -> poketrace; headline moved £135.63 -> £44.21 (67%) |
...
| DRIFT | `pawmi-paldean-fates-226-raw.json` | Pawmi · Paldean Fates · 226/091 · RAW | £8.86 · pokemon-price-tracker · low · manual | £2.35 · poketrace · medium · manual | confidence low -> medium; headline source pokemon-price-tracker -> poketrace; headline moved £8.86 -> £2.35 (73%) |
...
| DRIFT | `rough-gengarr-lor-tg06-raw.json` | Gengarr lor tg TG06 raw £10 LP vinted binder · RAW | £135.63 · pokemon-price-tracker · low · manual | £44.21 · poketrace · high · auto | confidence low -> high; manual true -> false; headline source pokemon-price-tracker -> poketrace; headline moved £135.63 -> £44.21 (67%) |
...
- Most drift is expected live-market movement and source mix changes: PokeTrace is now contributing materially to RAW comps, while the fixtures were pinned against earlier source behaviour.
- The notable identity risk is `umbreon-evolving-skies-raw-ambiguous.json`: a bare "Umbreon / Evolving Skies" production lookup resolves to a different Umbreon V printing. This should stay manual/ambiguous and push the dealer toward selecting a preview row before comping.
- Several graded/odd-grade examples still return no live headline (`Victini ACE 10`, `Zapdos BGS 9.5`, `Lugia CGC 1.5`). Manual eBay UK solds plus dealer-logged checked comps remain the correct fallback until eBay MI approval or another UK sold source is live.
- No reconciler threshold changes were made from this report.
